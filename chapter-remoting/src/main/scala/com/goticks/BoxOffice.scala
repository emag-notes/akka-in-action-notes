...
object BoxOffice {
  ...
  case class CreateEvent(name: String, tickets: Int) extends JsonSerializable
  case class GetEvent(name: String) extends JsonSerializable
  case object GetEvents extends JsonSerializable
  case class GetTickets(event: String, tickets: Int) extends JsonSerializable
  case class CancelEvent(event: String) extends JsonSerializable

  case class Event(name: String, tickets: Int) extends JsonSerializable
  case class Events(events: Vector[Event]) extends JsonSerializable

  sealed trait EventResponse extends JsonSerializable
